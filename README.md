...
Para cuantificar el impacto real se requiere ajustar:

- ubicación de origen y destino;
- escala de celdas;
- posición exacta de rampas y escaleras;
- geometría obtenida del modelo BIM o de planos georreferenciados.

### Experimento estocástico

Con los hiperparámetros actuales, la evaluación estocástica obtuvo una tasa de éxito
de `0 %`.

Este resultado se reporta sin ocultarlo. Indica que esa variante necesita:

- mayor número de episodios;
- ajuste de exploración;
- revisión de la recompensa;
- posible ampliación del estado;
- evaluación con varias semillas.

## Pruebas automáticas

El notebook verifica mediante `assert`:

- dimensiones correctas del mapa;
...
- prohibición de escaleras para movilidad reducida;
- autorización de rampas;
- finalización al llegar al destino;
- dimensiones correctas de la tabla Q;
- coherencia de probabilidades estocásticas.

## Gráficos y salidas del notebook

El notebook genera:

- visualización de los escenarios antes y después;
...
- tablas de métricas;
- análisis automático de resultados;
- experimento de hiperparámetros;
- ejemplo manual de actualización de Q-Learning y SARSA.
...
1. Presionar el botón **Abrir en Google Colab**.
...
3. Esperar a que finalicen los entrenamientos.
4. Revisar las tablas, rutas, gráficos y conclusiones generadas.
...
Probado en la ejecución guardada con:
...
2. Problemática real
3. Objetivos
4. Justificación del uso de RL
5. Formulación como MDP
6. Sistema de recompensas
7. Códigos del Gridworld
8. Construcción de escenarios
9. Clase EntornoBertello
10. Pruebas del entorno
11. Política epsilon-greedy
12. Agente aleatorio
13. Q-Learning
14. SARSA
15. Evaluación greedy
16. Curvas de aprendizaje
17. Comparación de resultados
18. Rutas por perfil
19. Comparación antes y después
20. Experimentos de hiperparámetros
21. Ejemplo manual de actualización Q
22. Mapa de política y valor
23. Entorno estocástico
24. Análisis automático
25. Respuestas para la sustentación
26. Correspondencia con la rúbrica
```
...
| Criterio | Evidencia |
|---|---|
| Modelado del problema — 3 puntos | Agente, entorno, estados, acciones, recompensas, transiciones y episodios |
| Solución planteada — 4 puntos | Entorno, agente aleatorio, epsilon-greedy, Q-Learning y SARSA |
| Resultados obtenidos — 4 puntos | Métricas, rutas, gráficos, tablas y evaluación greedy |
| Análisis de resultados — 5 puntos | Comparación de algoritmos, perfiles, hiperparámetros y estocasticidad |
| Comprensión del algoritmo — 4 puntos | Implementación manual, comentarios, fórmulas y ejemplos numéricos |
...
- tokens;
- rutas internas;
- información personal de pobladores.

El repositorio contiene únicamente el código académico y una representación
hipotética del entorno.
